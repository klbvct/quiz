...
<div class="container">
    ...
    <section id="notes">
        ...
        <ol style="margin-left: 20px;">
            <li>Вивчити представлені напрямки навчання та їх значення. Зрозуміти, що вивчатиметься в рамках цих напрямків, ознайомитись з планом навчання.</li>
            <li>Вибрати галузь знань та дізнатися в ВНЗ, які цікавлять, можливість підготовчих програм. Я завжди рекомендую абітурієнтам проходити підготовчу програму перед університетом – це дає додаткові привілеї під час вступу.</li>
            <li>Розглянути можливість додаткових професійних занять з профільним предметам. Спеціалізовані факультети звертають особливу увагу на кількість балів за профілем.</li>
            <li>Цілеспрямована підготовка до вступу починається з 9 класу, в ідеалі.</li>
            <li>Дані тесту дають можливість зрозуміти, у яких напрямках є схильності на даний момент. Як зупинитися на чомусь одному? До ваших нахилів та інтересів ви додаєте вашу мотивацію. Так буде простіше зрозуміти на чому зупинити свій вибір зараз.</li>
            <li>Оцінюємо знання англійської та можливість здачі міжнародних іспитів для отримання сертифіката під час вирішення навчатися за кордоном. Крім англійської вчимо БУДЬ-ЯКУ ІНШУ поширену іноземну мову! Мови в сучасному світі – вже не додаткова, а для більшості професій – обов'язкова навичка.</li>
            <li>Запам'ятайте! Бакалаврат – базова освіта, на якій буде засновано ваше подальше професійне життя. Ці 3-4 роки можна провчитися з величезною користю для подальшої кар'єри, а можна просто витратити і починати все спочатку.</li>
            <li>Чим базовіший, фундаментальний напрямок вивчається на бакалавріаті, тим більше її складові стануть у нагоді надалі.</li>
            <li>Монопрофесії вже у минулому. Сучасні люди здатні здобути не одну професійну навичку в різних сферах. Комбінуйте навички з різних галузей знань. Це цікаво і дає величезну перевагу у майбутньому.</li>
            <li>Не забувайте про цифрові навички, які межують з основною спеціальністю. Сьогодні фахівець в будь-якій галузі повинен працювати в умовах цифровізації і технологізації.</li>
        </ol>
