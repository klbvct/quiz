...
<div class="container">
    ...
    <section id="thinking-types">
            ...
            @foreach($thinkingTypes as $key => $name)
                ...
                <div class="chart-bar">
                    <div class="chart-label">
                        ...
                        <span class="chart-label-value">{{ $scores['module1'][$key] }} балів ({{ $totalThinking > 0 ? round(($scores['module1'][$key] / $totalThinking) * 100) : 0 }}%)</span>
                    </div>
                    <div class="bar-bg">
                        <div class="bar-fill" style="width: {{ $totalThinking > 0 ? ($scores['module1'][$key] / $totalThinking) * 100 : 0 }}%"></div>
                    </div>
                </div>
                @endif
            @endforeach
        ...
        <ul class="content-list">
            <li><strong>Художнє (наочно-образне) мислення</strong> – інструмент, який дозволяє нам конструювати в уяві неіснуючу реальність або перетворювати існуючу на щось нове. Створювати образи та оперування ними у процесі вирішення поставлених завдань – основна стратегія цього типу мислення. Розвинуто візуальне сприйняття та уяву.</li>
            <li><strong>Теоретичне мислення</strong> – дозволяє узагальнювати, порівнювати, аналізувати та класифікувати накопичені знання та уявлення, виражаючи у формі норм, правил, законів, концепцій, книг. Абстрактне, узагальнене відображення. Дозволяє знаходити причинно-наслідкові зв'язки у явищах та предметах, шукати відповідь на запитання «чому?».</li>
            <li><strong>Практичне мислення</strong> – теорії перевіряються практично – схеми, креслення, проекти, плани перетворюють теоретичні поняття на реальну дійсність. Думка набуває фізичної форми. Характерно для людей, орієнтованих на результат, а не на процес.</li>
            <li><strong>Творче (продуктивне) мислення</strong> – оригінальність ідей, нетривіальність, гнучкість. Пошук нових рішень для існуючих завдань чи проблемних ситуацій. Така людина завжди прагне знайти своє власне оригінальне рішення. Здатність продукувати нові ідеї в різних ситуаціях невизначеності на основі раніше відомої інформації.</li>
            <li><strong>Конвергентне мислення</strong> – («бізнес-мислення») система поглядів на світ і особливостей розумового процесу, базою до якого є твердження: «ми самі відтворюємо своє життя». Визначається вірою в можливість будувати власну реальність, адаптуватися до певних умов. Ключовими умовами виступають: самостійність, відповідальність, широта поглядів, дальнобачність, готовність до ризику, віра в себе.</li>
            <li><strong>Інтуїтивне мислення</strong> – це спосіб прийняття рішень, в якому результат виникає швидко й без явного логічного аналізу. Людина отримує відповідь на основі підсвідомого досвіду, емоцій або власних відчуттів, часто не усвідомлюючи, як саме вона до нього дійшла.</li>
            <li><strong>Аналітичне мислення</strong> – особливий тип абстрактного мислення, яке допомагає структурувати, конструювати і оперувати абстрактними поняттями. Стимулює здатність розкладувати великі завдання на дрібні складові, логічно переосмислюючи їх.</li>
        </ul>
    </section>
    @endif
